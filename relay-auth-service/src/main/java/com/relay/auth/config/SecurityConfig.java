 ...
 * Public routes: /actuator/health, POST /api/auth/login, POST /api/auth/register — all other requests require a valid token.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .csrf(AbstractHttpConfigurer::disable) // codeql[java/spring-disabled-csrf-protection] - stateless API, JWT-based auth, no session cookies
